...
urlpatterns = patterns('',
	...
	url(r'^(?P<punchlist_id>\d+)/issue/addnote/(?P<issue_id>\d+)/$', views.add_note, name='add_note'),
	...
	url(r'^(?P<punchlist_id>\d+)/issue/delete/(?P<issue_id>\d+)/$', views.delete_issue, name='delete_issue'),
)